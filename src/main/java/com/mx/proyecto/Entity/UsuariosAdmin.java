...
@Table(name = "USUARIOS_ADMIN", schema = "PROYECTOSPRING") // Anotacion table donde indicamos el nombre de la tabla y el esquema
public class UsuariosAdmin {
	
	@Id // SIRVE PARA INDICAR  QUE EL CAMPO/ATRIBUTO VA A SER UN ID
